kali linux官网https://www.kali.org/
...
<a>这里有一个大坑 用Win32DiskImager做成的启动盘死活装不进去,不是无法挂载光盘就是无法加载组件,试了好久，发现有一款工具可以解决该问题:<a href='https://github.com/educationhacker/installkalilinux/blob/master/pc.md'>下载地址</a>  </a>
</div>
